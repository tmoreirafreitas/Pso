...
{
    public class ParcelaUpdatedNotificationHandler : UpdatedNotificationHandler<Parcela>
    {
        ...
        public ParcelaUpdatedNotificationHandler(IWriteMongoRepository<Parcela> repository,
        ...
        public override async Task Handle(UpdateCommand<Parcela> notification, CancellationToken cancellationToken)
        {
